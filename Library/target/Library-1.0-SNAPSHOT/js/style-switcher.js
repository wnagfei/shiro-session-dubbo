...
StyleSwitcher.prototype.build = function () {
    ...
    $('body').css({
        'background-image': 'url(' + imgPath + 'asse../images/pattern/' + $this.storageManager.getBgImage() + '.png)',
    ...
    if (itm.ci) {
        ...
        var colorSelStyle = $('<link/>')
            ...
            colorSelHackStyle = $('<link/>').attr({
                'rel': 'stylesheet',
                'href': imgPath + 'css/colorpicker_hack.css'
            });
    ...
    $.each(patternImages, function (i) {
        var listElement = $('<li/>').append($('<a/>').css({
                'background': 'url(' + imgPath + 'asse../images/pattern/' + patternImages[i].image + '.png) repeat'
            }).attr({
                'href': '#',
    ...
    patternList.find('a').on(Metis.buttonPressedEvent, function (e) {
        e.preventDefault();
        $('body').css({
            'background-image': 'url(' + imgPath + 'asse../images/pattern/' + $(this).data('patternImage') + '.png)',
            'background-repeat': ' repeat'
        });
